...
- فريقنا لديه خبرة قوية في مجموعة التقنيات المختارة: لقد بنينا تطبيقات Vue/Nuxt.js و .NET من قبل ونحن ماهرون في قواعد بيانات SQL Server. هذا يعني أنه يمكننا تطوير واجهة المستخدم الأمامية والخادم الخلفي بكفاءة.
...
- **مطورو الخلفية (2):**  
  بناء وصيانة منطق الخادم في .NET، إدارة قاعدة بيانات SQL Server، وتنفيذ واجهات برمجة التطبيقات. أحد مطوري الخلفية سيتولى أيضاً **مسؤوليات DevOps**، التعامل مع البنية التحتية السحابية، خطوط CI/CD، والأمان. معاً، سينفذون أيضاً تنفيذ الأكواد في الوقت الفعلي والتكامل مع واجهات برمجة التطبيقات للذكاء الاصطناعي. 
...
![الشكل 3.1: أدوار فريق التطوير](../../public/assets/CH03/Figure_3.1_Development_Team_Roles.svg)
...
![الشكل 3.2: صافي الربح لكل سنة](../../public/assets/CH03/Figure_3.2_Net_Profit_per_Year.svg)
...
![الشكل 3.3: الإيرادات التراكمية مقابل التكلفة التراكمية](../../public/assets/CH03/Figure_3.3_Cumulative_Revenue_vs_Cumulative_Cost.svg)
