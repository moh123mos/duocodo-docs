...
export default withMermaid({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/guide/": [
        { text: "CH1: Introduction", link: "/guide/ch1" },
        {
          text: "CH2: Background",
          collapsed: true,
          items: [
            { text: "Background", link: "/guide/ch2/background" },
            { text: "Technologies", link: "/guide/ch2/technologies" },
            { text: "Related Work", link: "/guide/ch2/related-work" },
            { text: "Summary", link: "/guide/ch2/summary" },
          ],
        },
        {
          ...
          items: [
            {
              ...
              link: "/guide/ch4/functional-requirements",
            },
            {
              text: "Non-Functional Requirements",
              link: "/guide/ch4/non-functional",
            },
            {
              text: "Functional Decomposition",
              link: "/guide/ch4/functional-decomposition",
            },
          ],
        },
        {
        ...
        {
          text: "CH7: User Interface",
          collapsed: true,
          items: [
            { text: "Overview", link: "/guide/ch7/user-interface" },
            { text: "Authentication Screens", link: "/guide/ch7/authentication" },
            { text: "Main Dashboard", link: "/guide/ch7/main-dashboard" },
            { text: "Learning Paths", link: "/guide/ch7/learning-paths" },
            { text: "Progress & Analytics", link: "/guide/ch7/progress-analytics" },
            { text: "Theme Options", link: "/guide/ch7/theme-options" },
          ],
        },
        {
          ...
          "/ar/guide/": [
            {
              ...
              collapsed: false,
              items: [{ text: "نظرة عامة", link: "/ar/guide/ch1" }],
            },
            {
              text: "الفصل الثاني: الخلفية",
              collapsed: true,
              items: [{ text: "الخلفية", link: "/ar/guide/ch2/background" }],
            },
            {
              ...
              items: [
                {
                  ...
                  link: "/ar/guide/ch3/requirement-analysis",
                },
                {
                  text: "دراسة الجدوى",
                  link: "/ar/guide/ch3/feasibility-study",
                },
                {
                  text: "إدارة المخاطر",
                  link: "/ar/guide/ch3/risk-management",
                },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "المتطلبات غير الوظيفية",
                  link: "/ar/guide/ch4/non-functional",
                },
              ],
            },
            // {
